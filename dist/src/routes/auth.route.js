...
let AuthRoute = class AuthRoute {
    initializeRoutes() {
        this.router.post(`${this.path}signup`, (0, _validationmiddleware.ValidationMiddleware)(_usersdto.CreateUserDto), this.authController.signUp);
        this.router.post(`${this.path}login`, (0, _validationmiddleware.ValidationMiddleware)(_usersdto.CreateUserDto), this.authController.signIn);
    }
    constructor(){
